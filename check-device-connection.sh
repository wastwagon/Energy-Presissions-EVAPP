...
echo "  - Server URL: ws://192.168.9.108:3000/ocpp/{chargePointId}"
echo "  - Charger IP: 192.168.9.106"
echo "  - Gateway: 192.168.9.1"
echo ""
echo "Device 2 (192.168.0.x network):"
echo "  - Charge ID: 09003307101119"
echo "  - Server URL: ws://192.168.0.101:3000/ocpp/{chargePointId}"
echo "  - Charger IP: 192.168.0.100"
echo "  - Gateway: 192.168.0.1"
echo ""
echo "IMPORTANT:"
echo "  - Include charge point ID in URL path: /ocpp/{chargePointId}"
echo "  - Ensure the port is 3000 for embedded OCPP"
